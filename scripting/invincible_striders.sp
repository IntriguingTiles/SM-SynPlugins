...
public Plugin myinfo =
{
	...
	description = "Makes striders invincible on d3_c17_13 and ep1_c17_06 until you run a command to make them vulnerable.",
	version = "1.0",
};
...
public Action Cmd_EnableStriderDmg(int client, int args)
{
	if (!g_isCorrectMap)
	{
		ReplyToCommand(client, "[SM] This command can only be used on d3_c17_13 or ep1_c17_06");
...
public void OnMapStart()
{
	...
	g_isCorrectMap = StrEqual(mapName, "d3_c17_13", false) || StrEqual(mapName, "ep1_c17_06", false);
}
